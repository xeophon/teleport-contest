...
Your fork's **category** reflects how you (plan to) produce most of the code (over 50%).
**Agentic** entries are primarily generated by an LLM-driven workflow,
while **Transpiled** entries are mostly produced by transpiling the C sources with tools.

If your plans don't fit in either category, you can select "other" and reach out to us if you'd like!
