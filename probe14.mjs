...
const sessionData = JSON.parse(readFileSync(join(PROJECT_ROOT, 'sessions/seed0014-dequa-fountain-explore.session.json'), 'utf8'));
...
writeFileSync('/tmp/nh-cont9150/js14_rng_dump.json', JSON.stringify(jsRng));
console.log('wrote', jsRng.length);
