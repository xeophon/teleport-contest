...
5. Level, trap, terrain, save, and display foundations.
   - Source notes: `docs/c-parity-audit/03-levelgen-specials-quest.md`, `06-save-restore-bones.md`, `07-traps-liquids-terrain.md`, `08-display-rng-observation.md`, `docs/c-parity-audit/92-subagent-findings-2026-05-28.md`, and `docs/c-parity-audit/93-subagent-findings-2026-05-28.md`.
...
5. Add lit-oil explosion floor collateral for adjacent burnable floor objects before broader `explode()` terrain/shop-damage parity.
6. Keep forced-chest follow-ups narrow and source-backed: mimic/disguise apparent-name details and ice-box corpse timer details.
