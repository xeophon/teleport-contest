...
1. Broaden direct `potionhit()` delivery beyond confusion/booze/paralysis/sleeping/blindness/speed/invisibility/hallucination/healing-family/common-no-effect/oil/sickness/neutral-water/acid/special-water-shapechanger-saddle through the next compact C-backed family; polymorph needs `bhitm()`/`newcham()` coverage, full burning-oil explosion collateral belongs with broader explosion work, and shifted-vampire lethal revival belongs with broader monster death lifecycle work.
