...
- Latest compact/source note: `docs/c-parity-audit/428-monster-crude-dagger-intervening-rust-2026-06-04.md`.
...
2. Direct object-hit and potion delivery.
   - Source notes: `docs/c-parity-audit/04-monsters-combat-pets.md` and latest compact note `docs/c-parity-audit/428-monster-crude-dagger-intervening-rust-2026-06-04.md`.
   - Continue broadening `potionhit()`, `toss_up()`, direct object-hit, and passive-object delivery one source-backed edge at a time. Monster-thrown potion intervening-monster hits are covered in audit 426, accidental acid-kill attribution is covered in audit 427, and crude-dagger intervening passive-object delivery is covered in audit 428.
