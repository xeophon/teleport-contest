...
2. Direct object-hit and potion delivery.
   ...
   - Remaining gaps include broader burning-oil terrain collateral beyond covered floor objects/webs/slime cleanup, other shifted-vampire death channels outside the water branch, and full `newcham()` target-selection/equipment fallout beyond the narrow polymorph-potion slice.
...
4. Monster placement, scheduler, and combat cores.
   - Source notes: `docs/c-parity-audit/04-monsters-combat-pets.md`, `docs/c-parity-audit/92-subagent-findings-2026-05-28.md`, and `docs/c-parity-audit/95-subagent-findings-2026-05-28.md`.
...
1. Broaden direct `potionhit()` delivery only through a newly selected compact C-backed edge. Broader burning-oil terrain collateral still belongs with terrain work; floor objects, webs, and hero slime cleanup are covered, while ice/water/fountains/doors remain open. Other shifted-vampire death channels belong with monster death lifecycle work, and full `newcham()` fidelity belongs with the monster lifecycle/equipment core.
