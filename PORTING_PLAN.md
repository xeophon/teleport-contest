...
1. Shop ledger foundation.
   ...
   - Current JS has a starter bill ledger; `unpaid`/`unpaidPrice` now act mostly as compatibility/display fields in covered shop paths, but some debt/loss helpers still use legacy field fallbacks.
