...
1. Broaden direct `potionhit()` delivery beyond confusion/booze/paralysis/sleeping/blindness/speed/invisibility/hallucination/healing-family/common-no-effect/unlit-oil/sickness/neutral-water/acid/special-water-shapechanger-saddle through the next compact C-backed family; lit-oil/polymorph need explosion and object-effect coverage, and shifted-vampire lethal revival belongs with broader monster death lifecycle work.
