...
1. Continue ordinary victual runtime beyond the covered carried delayed rows (`food ration`, `pancake`, `lembas wafer`, and `cram ration`): floor food including floor cursed/rotten delayed handling, exact interruption/resume messages, choking/full-warning behavior, apple, and fortune cookie remain separate source-backed slices.
