...
2. Move payment toward a complete C `dopay()` model through multi-shopkeeper `Pay whom?`, angry-adjacent priority, resident/visible-shopkeeper scan differences, angry/robbed no-bill branches, and remaining itemized prompt edge cases.
