...
- Added bounded egg timer parity: shared hatch-timer kill/dead-species helpers, proactive genocide cleanup across carried, floor, buried, contained, monster-inventory, migration, and saved-level object graphs, and hatch-time unique/genocided/extinct blocking without consuming blocked egg stacks.
...
2. Continue object timer work with contained due egg expiration: C consumes timers for contained eggs without hatching them, while inventory, floor, and monster-inventory eggs remain hatch candidates.
