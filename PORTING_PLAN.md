...
6. Add a bounded egg timer parity slice before a full timer registry: shared hatch-timer kill helper, genocide/extinction dead-species checks, and proactive genocide cleanup for current JS object graphs while preserving species on killed eggs.
