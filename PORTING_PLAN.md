...
- Latest compact/source note: `docs/c-parity-audit/246-tiphat-apparent-mimics-2026-05-31.md`.
...
6. Command, prompt, and menu contracts.
   ...
   - Remaining command candidates: remaining `tiphat()` noise/steed/unseen/statue reactions and reusable `getobj()` extraction.
