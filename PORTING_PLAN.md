...
1. Continue ordinary victual runtime beyond the covered carried/floor delayed rows (`food ration`, `pancake`, `lembas wafer`, `cram ration`, `tripe ration`, and `enormous meatball`) and covered delay-one apple/orange/pear/melon/banana/carrot/meatball/kelp-frond/slime-mold/sprig-of-wolfsbane/clove-of-garlic/eucalyptus-leaf/cream-pie/candy-bar/fortune-cookie/K-ration/C-ration rows: broader non-ordinary food branches, remaining special delay-one rows/effects, meat-ring flesh conduct, and remaining platform-specific apple message policy remain separate slices.
