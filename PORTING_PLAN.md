...
3. Finish remaining `sellobj()` follow-ups: complete recursive `subfrombill()` integration, less ordinary projectile ownership branches beyond same-shop paid/gold landing, and shared-helper integration for less ordinary object transfers.
