...
2. Direct object-hit and potion delivery.
   ...
   - Remaining gaps include exact visibility/message handling beyond covered direct/vapor cases, test-only adjacent common no-effect vapor coverage, shifted-vampire lethal revival, full burning-oil explosion collateral, identity-independent unknown-potion direct routing, and full `newcham()` target-selection/equipment fallout beyond the narrow polymorph-potion slice.
