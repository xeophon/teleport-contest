...
1. Broaden direct `potionhit()` delivery beyond confusion/booze/paralysis/sleeping/blindness/speed/invisibility/hallucination/healing-family/common-no-effect/unlit-oil/sickness/neutral-water through the next compact C-backed family; harming and acid need resistance/damage/death plumbing, while special-water/lit-oil/polymorph need target-aware gating, saddle, explosion, and object-effect coverage.
