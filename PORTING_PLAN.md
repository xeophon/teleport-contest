...
1. Continue ordinary victual runtime beyond the covered carried/floor delayed rows (`food ration`, `pancake`, `lembas wafer`, and `cram ration`): exact interruption/resume messages, choking/full-warning behavior, delay-one apple behavior, fortune-cookie paper/rumor behavior, and broader non-ordinary floor food branches remain separate source-backed slices.
