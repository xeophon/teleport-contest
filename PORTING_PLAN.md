...
- Latest compact/source note: `docs/c-parity-audit/339-direct-blinding-venom-hmon-2026-05-31.md`.
...
2. Direct object-hit and potion delivery.
   - Source notes: `docs/c-parity-audit/04-monsters-combat-pets.md` and latest compact note `docs/c-parity-audit/339-direct-blinding-venom-hmon-2026-05-31.md`.
...
4. Direct delivery work: broaden `potionhit()`/`toss_up()` and direct object-hit only through newly selected compact C-backed edges; direct potionhit paralysis chip-RNG and wakeup cleanup ordering is covered in audit 337, and direct hero-thrown blinding-venom `hmon()` hits are covered in audit 339. Avoid broad monster lifecycle rewrites without tests.
