...
- Covered focused stone-to-flesh, object polymorph, wand-polymorph floor-pile shudder, vertical wand-polymorph pile targeting, lateral wand-polymorph floor-pile ray traversal, monster-first wand-polymorph ray hits, pet food, metallivorous `#eat`, and metal accessory slices.
...
- Latest compact/source note: `docs/c-parity-audit/211-lateral-wand-polymorph-monster-first-2026-05-30.md`.
