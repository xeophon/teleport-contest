...
7. Continue shop-bill cleanup past the covered full-bill slices: dummy `costly_alteration()` full-bill behavior and remaining shared `addtobill()`/`subfrombill()` integration still need source-shaped helpers.
