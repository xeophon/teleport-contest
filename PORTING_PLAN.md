...
2. Direct object-hit and potion delivery.
   ...
   - Remaining gaps include bash delivery, non-`kn` `trycall()` prompts, exact visibility/discovery handling beyond covered direct/vapor cases, adjacent vapor for common no-effect potions, remaining special-water were/vampire effects, and lit-oil/polymorph effects.
