...
- Latest compact/source note: `docs/c-parity-audit/390-redirected-launcher-arrow-misfire-iron-bars-2026-06-04.md`.
...
4. Monster placement, scheduler, and combat cores.
   - Source notes: `docs/c-parity-audit/04-monsters-combat-pets.md` and latest compact note `docs/c-parity-audit/390-redirected-launcher-arrow-misfire-iron-bars-2026-06-04.md`.
   - Build shared `goodpos`, `enexto`, monster lifecycle, turn phases, `hmon`, `mattackm`, passive, and projectile/object-hit paths.
   - Compact candidates: direct monster-object hit follow-ups, remaining monster-thrown `passive_obj()` follow-ups, remaining launcher-arrow normal-flight obstacle follow-ups, full monster diet flag generation, and broader `polymon()`/stoning interactions.
