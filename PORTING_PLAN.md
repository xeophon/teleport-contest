...
4. Continue wish finalization by replacing local parser/finalizer tables with registry-backed `oc_merge`, `oc_charged`, `oc_nowish`, canonical weight, and artifact provenance rules; next small rows include meat ring non-mergeability/weight, candle merge/weight, horn-of-plenty metadata, and wand-of-wishing charge tests.
