...
- Latest compact/source note: `docs/c-parity-audit/176-wish-lamp-range-2026-05-29.md`.
- Latest verified public score: `44/44`.

## Current Priorities

1. Shared shop ownership helpers.
   - Source notes: `docs/c-parity-audit/05-food-inventory-containers-shops.md` and latest compact note `docs/c-parity-audit/176-wish-lamp-range-2026-05-29.md`.
...
2. Direct object-hit and potion delivery.
   - Source notes: `docs/c-parity-audit/04-monsters-combat-pets.md` and latest compact note `docs/c-parity-audit/176-wish-lamp-range-2026-05-29.md`.
...
3. Object registry and canonical object factory.
   - Source notes: `docs/c-parity-audit/02-objects-wishing-readobjnam.md` and latest compact note `docs/c-parity-audit/176-wish-lamp-range-2026-05-29.md`.
   ...
   - Generic C `readobjnam` object ranges for `bag`, `lamp`, `candle`, and `horn` are covered; continue replacing parser-local wish and merge tables with registry-backed finalization, artifact provenance, save/bones fruit-id handling, remaining armor/clothing ranges, `sword`, dragon scale/mail zero-prob ranges, and venom aliases/policy.
...
5. Level, trap, terrain, save, and display foundations.
   - Source notes: `docs/c-parity-audit/03-levelgen-specials-quest.md`, `docs/c-parity-audit/06-save-restore-bones.md`, `docs/c-parity-audit/07-traps-liquids-terrain.md`, `docs/c-parity-audit/08-display-rng-observation.md`, and latest compact note `docs/c-parity-audit/176-wish-lamp-range-2026-05-29.md`.
...
6. Command, prompt, and menu contracts.
   - Source notes: `docs/c-parity-audit/01-input-commands-windows.md` and latest compact note `docs/c-parity-audit/176-wish-lamp-range-2026-05-29.md`.
...
5. Registry/diet work: C `readobjnam` object ranges for `bag`, `lamp`, `candle`, and `horn` are covered; remaining object registry work includes armor/clothing ranges, `sword`, dragon scale/mail zero-prob ranges, venom range aliases/policy, and registry-backed metadata consolidation. Remaining diet metadata should be caller-led, including full monster diet flag generation and remaining metal-accessory fullness/cursed/worn-ring/strangulation cleanup.
