...
1. Shared shop ownership helpers.
   ...
   - Latest compact source note: `docs/c-parity-audit/125-subagent-findings-2026-05-29.md`.
...
2. Keep remaining stone-to-flesh work narrow: the non-golem vegetarian meatball row and carried non-shop-billed non-golem non-vegetarian figurine animation are covered. Next cover only one floor figurine, statue animation, golem/flesh-golem transformation, shop-billed animation, contents transfer, failed-animation corpse-fallback, or broader `poly_obj()` fallout row at a time.
