...
1. Shared shop ownership helpers.
   ...
   - Latest compact source note: `docs/c-parity-audit/123-subagent-findings-2026-05-29.md`.
...
4. Monster placement, scheduler, and combat cores.
   ...
   - Compact current candidates: direct monster-object hit follow-ups, ghoul pet-food preferences beyond the covered stone-to-flesh meat branch, and broader `polymon()` stoning interactions.
