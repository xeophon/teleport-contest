...
1. Broaden direct `potionhit()` delivery beyond confusion/booze/paralysis/sleeping/blindness/speed/invisibility/hallucination/healing-family/common-no-effect/unlit-oil/sickness/neutral-water/acid through the next compact C-backed family; special-water needs target-aware damage/split/rust/transformation helpers, while lit-oil/polymorph need explosion and object-effect coverage.
