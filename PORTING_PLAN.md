...
4. Monster placement, scheduler, and combat cores.
   - Source notes: `docs/c-parity-audit/04-monsters-combat-pets.md` and `docs/c-parity-audit/92-subagent-findings-2026-05-28.md`.
...
5. Level, trap, terrain, save, and display foundations.
   - Source notes: `docs/c-parity-audit/03-levelgen-specials-quest.md`, `06-save-restore-bones.md`, `07-traps-liquids-terrain.md`, `08-display-rng-observation.md`, and `docs/c-parity-audit/92-subagent-findings-2026-05-28.md`.
...
2. Keep remaining stone-to-flesh work narrow: statue/figurine rows should wait for monster/statue lifecycle work, and broader `poly_obj()` fallout still needs source-backed tests before implementation.
...
5. Add themed-room buried zombie generation timers through `buriedobjlist` placement and 990-1010 turn `zombifyTurn` windows before broader buried-zombie emergence behavior.
6. Add lit-oil explosion floor collateral for adjacent burnable floor objects before broader `explode()` terrain/shop-damage parity.
7. Keep forced-chest follow-ups narrow and source-backed: mimic/disguise apparent-name details and ice-box corpse timer details.
