...
4. Finish remaining musical edge cases: manual tune `passthru`/drawbridge behavior, exact snake/nymph/mercenary polish, and any remaining charged-instrument callers that share `do_play_instrument()`.
