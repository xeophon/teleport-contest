...
1. Broaden direct `potionhit()` delivery beyond confusion/booze/paralysis/sleeping/blindness/speed/invisibility/hallucination/healing-family/common-no-effect/unlit-oil/sickness/neutral-water/acid/special-water-gremlin-iron-golem through the next compact C-backed family; remaining special-water needs saddle BUC effects plus undead/demon/were/vampire damage, healing, and transformation helpers, while lit-oil/polymorph need explosion and object-effect coverage.
