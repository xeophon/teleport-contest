...
- Latest compact/source note: `docs/c-parity-audit/204-plus-one-launcher-arrow-drop-throw-2026-05-30.md`.
...
5. Level, trap, terrain, save, and display foundations.
   - Source notes: `docs/c-parity-audit/03-levelgen-specials-quest.md`, `docs/c-parity-audit/06-save-restore-bones.md`, `docs/c-parity-audit/07-traps-liquids-terrain.md`, `docs/c-parity-audit/08-display-rng-observation.md`, and latest compact note `docs/c-parity-audit/205-stone-to-flesh-directed-doppelganger-statue-2026-05-30.md`.
   ...
   - Compact candidates: floor statue saved-traits animation, remaining cant-revive statue-trap sharing, broader hero-on-liquid fallout, and display/discovery ordering around object observation.
