...
4. Finish the remaining musical instrument shell: ordinary flute/harp/horn/bugle prompt effects, no-blow-form polish, and any remaining charged-instrument callers that share `do_play_instrument()`.
