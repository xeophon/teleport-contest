...
3. Finish remaining `sellobj()` follow-ups: complete recursive `subfrombill()` integration, less ordinary projectile ownership branches, hole/trapdoor `ship_object()` debt routing, and shared-helper integration for less ordinary object transfers.
