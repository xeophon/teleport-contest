...
2. Finish remaining `sellobj()` follow-ups: complete recursive `subfrombill()` integration, bill-aware drop stacking, broken/container projectile impact edge cases, and shared-helper integration for less ordinary object transfers.
