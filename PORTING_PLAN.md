...
- Latest compact/source note: `docs/c-parity-audit/337-potionhit-paralysis-wakeup-2026-05-31.md`.
...
4. Direct delivery work: broaden `potionhit()`/`toss_up()` and direct object-hit only through newly selected compact C-backed edges; direct potionhit paralysis chip-RNG and wakeup cleanup ordering is covered in audit 337. Avoid broad monster lifecycle rewrites without tests.
