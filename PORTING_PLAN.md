...
1. Shared shop ownership helpers.
   ...
   - Latest compact source note: `docs/c-parity-audit/124-subagent-findings-2026-05-29.md`.
...
2. Direct object-hit and potion delivery.
   ...
   - Remaining gaps include broader burning-oil terrain collateral beyond covered floor objects/webs/slime cleanup/ice/water/pool/fountain handling, other shifted-vampire death channels outside the water branch, and full `newcham()` target-selection/equipment fallout beyond the narrow polymorph-potion slice.
