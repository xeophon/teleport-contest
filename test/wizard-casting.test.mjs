...
for (const name of ['wizard-casting', 'spell-wizard-death', 'spell-rays', 'spell-direction-cancel', 'spell-explosions', 'armor-callbacks', 'effective-attributes', 'wounded-legs']) test(`fresh C oracle: ${name}`, () => {
