...
for (const name of ['wizard-casting', 'spell-wizard-death', 'spell-rays', 'spell-direction-cancel', 'spell-explosions', 'armor-callbacks', 'effective-attributes', 'wounded-legs', 'held-wish', 'rejected-wish', 'missing-weapons', 'wish-stacks', 'artifact-wish', 'artifact-refusal', 'artifact-helm', 'wizard-identify', 'sorted-identify', 'initial-stack', 'read-identify-select', 'read-identify-retries', 'spell-identify-select', 'traditional-identify-ask', 'traditional-identify-preview', 'traditional-identify-repeat', 'traditional-identify-all', 'traditional-identify-fallback', 'noun-fruit', 'inventory-names', 'wish-name-knowledge']) test(`fresh C oracle: ${name}`, () => {
