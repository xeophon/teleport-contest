...
for (const o of (game.level.objects||[])) if (o.cobj?.length || o.otyp===10029 || o.olocked!==undefined) console.log(JSON.stringify({otyp:o.otyp,x:o.ox,y:o.oy,cont:(o.cobj||[]).map(c=>c.otyp),locked:o.olocked,blessed:o.blessed,cursed:o.cursed}));
