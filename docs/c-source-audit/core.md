...
| `do.c` | `cmd.js`, `save.js`, `allmain.js` | `goto_level`, drop/floor effects, trap state, arrival timer interfaces. Earlier arrival overrides were removed. Complete timer/region/shop/holding order and unusual floor effects require further comparison. |
