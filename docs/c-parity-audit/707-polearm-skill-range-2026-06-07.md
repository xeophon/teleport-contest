...
- Full `use_pole()` impact parity still needs other artifact-specific behavior, worm cutting, and exact miss/wakeup messaging. Audit 711 covers engraving wiping; audit 712 covers passive object effects; audit 713 covers Snickersnee distance timing.
