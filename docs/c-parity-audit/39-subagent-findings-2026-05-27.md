...
- Broken-potion vapor should stay call-site-specific. Audit 40 covers hot-ground `breakobj()`; C also has vapor for inventory fire destruction and forced chest content shattering, but intentionally no vapor for cold, lava/floor fire boil, electrical destruction, random/non-hero migration, and generic object deletion (`zap.c:5917`, `do.c:352`, `lock.c:1285`).
...
- Audit 40 covers hot-ground vapor. Add call-site-specific broken-potion vapor for inventory fire destruction and forced chest content shattering; keep lava, cold, non-hero migration, and generic destruction no-vapor.
