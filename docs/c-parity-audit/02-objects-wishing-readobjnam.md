...
5. return an explicit result kind: object, terrain/trap/furniture wizard wish, hands/nothing, or no match; the no-match, exact no-wish, and selected wizard trap sentinels including beartrap/land-mine ambiguity exist, but the other result kinds still need the full C split
