...
- Exact `adjalign()` side effects such as Erinys adjustments, broader `peacefuls_respond()` cases beyond audit 762's ordinary-humanoid bystander subset, knockback/trap collisions, and special melee helpers remain separate. Blind fade-message suppression is covered by audit 761.
