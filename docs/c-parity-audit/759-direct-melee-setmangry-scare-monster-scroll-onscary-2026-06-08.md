...
- Exact `adjalign()` side effects such as Erinys adjustments, broader `peacefuls_respond()` cases beyond audits 762-764's humanoid and town-watch bystander subsets, knockback/trap collisions, and special melee helpers remain separate. Blind fade-message suppression is covered by audit 761.
