...
- Same-square seen holes/trap doors remain on the existing boulder-plug path for this slice; the C boulder exception that can knock floor piles through the gate is covered in audit 595.
