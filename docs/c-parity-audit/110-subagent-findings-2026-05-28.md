...
- Mirror, crystal ball, and lenses breakage is covered in `111-subagent-findings-2026-05-28.md`; blinding venom, expensive cameras, glass/crystal wands, crackable glass armor, and broader glass/crystal object breakage remain separate non-potion `toss_up()` slices.
