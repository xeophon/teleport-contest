...
- Full generic `potion_dip()` behavior: water effects, potion mixing/alchemy, oiling weapons, acid/corrosion, poison coating, unicorn horn/amethyst mixtures, and exact source menus for non-oil potions.
