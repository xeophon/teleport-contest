...
- Full `launch_obj()` parity remains broader trap/terrain work: hero collision along the rolling path, path trap effects, launch-drop preservation, and floor-effect integration. Unseen rolling-boulder launch feedback is covered in audit 584, door breakage is covered in audit 585, rock-thrower snatch feedback is covered in audit 586, iron-bars handling is covered in audit 587, and boulder chaining is covered in audit 588.
