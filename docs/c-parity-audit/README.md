...
- Continue moving payment toward complete C `dopay()` semantics for containers and queued itemized selections, and fix shop-floor magic-bag put-in so `sellobj()` resolves before explosion handling.
