...
- Full `launch_obj()` parity remains broader trap/terrain work: teleport and level-teleport path traps, pit/spiked-pit/hole/trapdoor floor effects, launch-drop preservation, final-placement floor effects, hero-triggered rolling-boulder rewriting, occupation/multi interruption, and mounted-steed diversion.
