...
- Full `launch_obj()` parity remains broader trap/terrain work: launch-drop preservation, floor-effect integration, hero-triggered rolling-boulder rewriting, occupation/multi interruption, and mounted-steed diversion. Path landmines are covered in audit 590, pit/hole path effects are covered in audit 591, and teleport path effects are covered in audit 592.
