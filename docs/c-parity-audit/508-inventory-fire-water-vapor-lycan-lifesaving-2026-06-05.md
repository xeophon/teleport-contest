...
- Fire trap, fire ray, and other command-level inventory-fire paths still need follow-up patches where their message queues currently flatten array metadata or return string-only helper output.
