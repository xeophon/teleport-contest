...
- Broader side effects still need exact shop billing/no-charge, timers/light-source shutdown, artifact/object immunities, exact body-part naming beyond ordinary hands, mimic reveal, invisible mapping, full pit escape with monster anchors, proficient `force_attack()`, floor snaring, dead-horse feedback, and exact wakeup visibility. Audit 720 covers Fumbling/Glib drops before this disarm branch, and audit 721 covers ordinary no-monster pit anchors.
