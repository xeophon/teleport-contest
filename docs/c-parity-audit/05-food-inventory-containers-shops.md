...
- Multi-object pickup now has priced menu rows, ordinary selected-object shop quotes before inventory lines, and scare-scroll floor-style used-up quotes; remaining quote/display gaps are container/contents quote edge cases and the full source `addtobill()` positioning across less ordinary transfer paths.
