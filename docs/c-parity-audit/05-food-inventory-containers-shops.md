...
- `js/cmd.js:9332-9463`, `js/cmd.js:34066-34123`, `js/cmd.js:34151-34153`, `js/cmd.js:34339-34341`, `js/cmd.js:39921-39932`: lamp and potion-of-oil apply paths that light/snuff, split oil-potion stacks, and route unpaid usage through C-style debit/used-up billing.
...
- `check_unpaid_usage()` is still partial. JS now has a reusable debit-only helper with C-style charged-object fee branches and callers for bag/horn use, wand zaps, camera use, can-of-grease applications, normal lamp and potion-of-oil apply lighting, successful spellbook study completion, alternate emptying, and drum-of-earthquake charges, but remaining marker, tinning-kit, magic-lamp rub, destroyed spellbooks, and other charge-consuming callers still need to route through the appropriate C billing paths.
