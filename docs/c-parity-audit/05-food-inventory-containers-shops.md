...
- Take-out has a starter C `lift_object()`-ordered preflight for slots and maximum-carry failure; it still does not cover burden prompts, partial stack lifting, artifact touch, or fatal-corpse checks.
